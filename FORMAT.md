...
- The 0.1.4 and 0.1.5 releases may reserve ids, add vectors, and stage v2 release
  files, but default writers still emit PAS1 + autocol v1 + zstd. autocol version
  2 and mkz block codec ids first become eligible for emitted interchange bytes in
  0.2.0.
